...
I'm a **20-year-old Full-Stack Developer** from **Ashgabat, Turkmenistan**, building high-quality web and mobile applications that go live and serve real users.

- 🚀 Founder of **[Online Market](https://onlinemarket.alwaysdata.net)** — a classifieds & e-commerce platform
- 🚗 Founder of **[Ulagym](https://ulagym.alwaysdata.net)** — a car marketplace for the Turkmenistan market
- 🤖 Building **scalper-style MQL5 trading bots** with strict risk management
- 🐍 Developing **Telegram bots** with Python for automation & notifications
